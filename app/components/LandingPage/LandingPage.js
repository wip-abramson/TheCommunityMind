...
const LandingPage = () =>
  <Jumbotron>
    ...
    <p>Through this website I hope to create a community based around sharing beautiful questions. These are defined by author of <a href="http://amorebeautifulquestion.com/" target="_blank">A More Beautiful Question</a>, Warren Berger as:</p>
    ...
    <p>In a world full of answers, questions are becoming ever more important. Why don't we share our questions? And by doing so might we be able to open soure creativity?</p>
